...
async def open_alarms_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """وقتی کاربر دکمه‌ی پایین '🔔 آلارم' رو می‌زنه"""
    await update.message.reply_text("منوی آلارم:", reply_markup=alarms_menu_keyboard())
...
def register_alarms_handlers(app):
    """این تابع رو bot.py صدا می‌زنه تا هندلرهای آلارم رو ثبت کنه"""
    ...
    app.add_handler(MessageHandler(filters.Regex("^🔔 آلارم$"), open_alarms_menu))
